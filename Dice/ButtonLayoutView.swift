...
struct ButtonLayout: View {
    ...
    struct DeviceWidthPrefenceKey: PreferenceKey {
     ...
     var body: some View {
             ...
             .overlay {
                 GeometryReader { geo in
                     Color.clear
                         .preference(key: DeviceWidthPrefenceKey.self, value: geo.size.width)
                 }
             }
             .onPreferenceChange(DeviceWidthPrefenceKey.self) { deviceWidth in
                 arrangeGridItems(diviceWidth: deviceWidth)
             }
